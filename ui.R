...
shinyUI(bootstrapPage(
  ...
  headerPanel("Meta-analysis Shiny Project Beta v2.1"),
    ...
    tabsetPanel(
      ...
      tabPanel("About",
               ...
               p('This web application is developed with',
                 ...
                 ''),
               br(),
               p('The code for this web application is available at this',
               ...
               strong('Code'),
               p('Sources for this code include',
                  br(),
                 a("Atsushi Mizumoto, PhD", href="http://mizumot.com", target="_blank"),
                  br(), 
                 a("Ryan Schulteis, MD", href="http://schulteisventures.net", target="_blank"),
                  br(),
                 a("William Kyle Hamilton", href="http://www.kylehamilton.com", target="_blank"),
                 br(),
                 a("psychstatistics on Github", href="https://github.com/psychstatistics", target="_blank")),
                  br(),  
